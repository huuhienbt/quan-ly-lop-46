...
window.moGocHocTap = async function() { 
    ...
    if (top15.length > 0) { 
        let listHtml = top15.map((s) => { 
            ...
            let titleBadge = "";
           let ongVangBadge = isOngVang ? `<div class="text-[10px] font-black text-yellow-800 bg-yellow-100 px-2 py-0.5 rounded border border-yellow-400 inline-flex items-center mt-1 shadow-sm"><img src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f41d.png" class="w-4 h-4 mr-1 drop-shadow-sm" alt="Ong Vàng">Ong Vàng Chăm Chỉ</div>` : "";
...
window.calculateTitle = function(student) {
    ...
    let ongVangBadge = isOngVang ? `<div class="text-[10px] font-black text-yellow-800 bg-yellow-100 px-2 py-0.5 rounded border border-yellow-400 inline-flex items-center shadow-sm"><img src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f41d.png" class="w-4 h-4 mr-1 drop-shadow-sm" alt="Ong Vàng">Ong Vàng Chăm Chỉ</div>` : "";
