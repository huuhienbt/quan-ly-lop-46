// ==========================================
// NÃO BỘ XỬ LÝ - V68 BẢN TỐI ƯU TỐC ĐỘ SIÊU NHANH (LAZY LOADING)
// ==========================================

// THẦY DÁN LINK API VÀO ĐÂY:
...
window.onload = async () => {
    try {
        // TỐI ƯU TỐC ĐỘ: Chỉ tải Danh sách HS và Bảng tin lúc khởi động để vào trang cực nhanh
...
async function loadSubject(sub) { 
    ...
    // Đã thay đổi: Fetch đồng thời Câu hỏi và Lịch sử làm bài
...
// ==========================================
// 🎯 KHO CÂU HỎI (ĐÃ ĐƯỢC GOM NHÓM LẠI THEO TUẦN)
// ==========================================
