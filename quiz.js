// --- GÓC HỌC TẬP & BẢNG VÀNG (THUẬT TOÁN ĐỒNG HẠNG VÀ THỜI GIAN) ---
async function moGocHocTap(fromRouter = false) { 
    ...
    // TÌM THỜI GIAN ĐẠT ĐIỂM (Chỉ tính nộp bài/cộng trừ điểm, loại vòng quay 0 điểm)
    ...
    // SẮP XẾP: Điểm cao trên. Bằng điểm -> Thời gian NHỎ HƠN (Sớm hơn) xếp trên
